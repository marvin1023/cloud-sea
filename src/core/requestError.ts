...
export class RequestError extends Error {
  ...
  public readonly retcode?: number; // 业务逻辑错误码
  public readonly statusCode?: number; // 服务器错误码
  public constructor(message: string, options: { type: RequestErrorType; retcode?: number; statusCode?: number }) {
    super(message);
